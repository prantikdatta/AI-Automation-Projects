...
from job_search_automation.config.final_score_weights import (
    FINAL_SCORE_WEIGHTS,
    TOTAL_WEIGHT,
)
...
class FinalScoreCalculator:
    ...
    into a recommendation that can be consumed directly by the
    ResumeMatcher and downstream pipeline.
    """
